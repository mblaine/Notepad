...
namespace Notepad
{
    public partial class About : Form
    {
        ...
        {
            lblAbout.Text = String.Format("Notepad version {0}", FileVersionInfo.GetVersionInfo(Assembly.GetExecutingAssembly().Location).FileVersion);
